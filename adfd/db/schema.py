...
t_phpbb_acl_groups = Table(
    "phpbb_acl_groups",
    metadata,
    Column("group_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    ...
    Column(
        "auth_role_id", Integer, nullable=False, index=True, server_default=text("'0'")
    ),
...
class PhpbbAclOption(Base):
    ...
    auth_option = Column(
        String(50, "utf8_bin"), nullable=False, unique=True, server_default=text("''")
    )
...
class PhpbbAclRole(Base):
    ...
    role_name = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    role_description = Column(Text, nullable=False)
    role_type = Column(
        String(10, "utf8_bin"), nullable=False, index=True, server_default=text("''")
    )
    role_order = Column(
...
class PhpbbAttachment(Base):
    ...
    is_orphan = Column(Integer, nullable=False, index=True, server_default=text("'1'"))
    physical_filename = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    real_filename = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    download_count = Column(Integer, nullable=False, server_default=text("'0'"))
    attach_comment = Column(Text, nullable=False)
    extension = Column(
        String(100, "utf8_bin"), nullable=False, server_default=text("''")
    )
    mimetype = Column(
        String(100, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbBanlist(Base):
    ...
    ban_ip = Column(String(40, "utf8_bin"), nullable=False, server_default=text("''"))
    ban_email = Column(
        String(100, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbBbcode(Base):
    ...
    bbcode_id = Column(SmallInteger, primary_key=True, server_default=text("'0'"))
    bbcode_tag = Column(
        String(16, "utf8_bin"), nullable=False, server_default=text("''")
    )
    bbcode_helpline = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbBoardrule(Base):
    ...
    rule_parent_id = Column(Integer, nullable=False, server_default=text("'0'"))
    rule_anchor = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    rule_title = Column(
        String(200, "utf8_bin"), nullable=False, server_default=text("''")
    )
    rule_message = Column(Text, nullable=False)
    rule_message_bbcode_uid = Column(
        String(8, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbBot(Base):
    ...
    bot_active = Column(Integer, nullable=False, index=True, server_default=text("'1'"))
    bot_name = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    bot_ip = Column(String(255, "utf8_bin"), nullable=False, server_default=text("''"))
...
t_phpbb_captcha_answers = Table(
    ...
    metadata,
    Column(
        "question_id", Integer, nullable=False, index=True, server_default=text("'0'")
    ),
    Column(
        "answer_text",
        String(255, "utf8_bin"),
...
class PhpbbCaptchaQuestion(Base):
    ...
    lang_iso = Column(
        String(30, "utf8_bin"), nullable=False, index=True, server_default=text("''")
    )
...
class PhpbbConfig(Base):
    ...
    config_name = Column(
        String(255, "utf8_bin"), primary_key=True, server_default=text("''")
    )
    config_value = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    is_dynamic = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
...
class PhpbbConfirm(Base):
    ...
    code = Column(String(8, "utf8_bin"), nullable=False, server_default=text("''"))
...
class PhpbbForum(Base):
    ...
    forum_desc_uid = Column(
        String(8, "utf8_bin"), nullable=False, server_default=text("''")
    )
    forum_link = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    forum_password = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    forum_rules_uid = Column(
        String(8, "utf8_bin"), nullable=False, server_default=text("''")
    )
    forum_topics_per_page = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    forum_last_poster_colour = Column(
        String(6, "utf8_bin"), nullable=False, server_default=text("''")
    )
    forum_flags = Column(Integer, nullable=False, server_default=text("'32'"))
    display_subforum_list = Column(Integer, nullable=False, server_default=text("'1'"))
    display_on_index = Column(Integer, nullable=False, server_default=text("'1'"))
    enable_indexing = Column(Integer, nullable=False, server_default=text("'1'"))
    ...
    enable_reputation = Column(Integer, nullable=False, server_default=text("'0'"))
    forum_posts_approved = Column(Integer, nullable=False, server_default=text("'0'"))
    forum_posts_unapproved = Column(Integer, nullable=False, server_default=text("'0'"))
    forum_posts_softdeleted = Column(
        Integer, nullable=False, server_default=text("'0'")
    )
    forum_topics_approved = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    enable_shadow_prune = Column(Integer, nullable=False, server_default=text("'0'"))
    prune_shadow_days = Column(Integer, nullable=False, server_default=text("'7'"))
    prune_shadow_freq = Column(Integer, nullable=False, server_default=text("'1'"))
...
t_phpbb_forums_watch = Table(
    "phpbb_forums_watch",
    metadata,
    Column("forum_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    Column("user_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    Column(
        "notify_status", Integer, nullable=False, index=True, server_default=text("'0'")
    ),
)
...
class PhpbbGroup(Base):
    ...
    group_founder_manage = Column(Integer, nullable=False, server_default=text("'0'"))
    group_name = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    group_avatar_type = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    group_avatar_width = Column(
        SmallInteger, nullable=False, server_default=text("'0'")
    )
    group_avatar_height = Column(
        SmallInteger, nullable=False, server_default=text("'0'")
    )
    ...
    group_sig_chars = Column(Integer, nullable=False, server_default=text("'0'"))
    group_receive_pm = Column(Integer, nullable=False, server_default=text("'0'"))
    group_message_limit = Column(Integer, nullable=False, server_default=text("'0'"))
    group_legend = Column(Integer, nullable=False, server_default=text("'0'"))
    group_max_recipients = Column(Integer, nullable=False, server_default=text("'0'"))
    group_skip_auth = Column(Integer, nullable=False, server_default=text("'0'"))
    group_reputation_power = Column(Integer, nullable=False, server_default=text("'0'"))
...
class PhpbbLang(Base):
    ...
    lang_dir = Column(String(30, "utf8_bin"), nullable=False, server_default=text("''"))
    lang_english_name = Column(
        String(100, "utf8_bin"), nullable=False, server_default=text("''")
    )
    lang_local_name = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    lang_author = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
...
class PhpbbLog(Base):
    ...
    log_type = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    user_id = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    forum_id = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    topic_id = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    reportee_id = Column(
        Integer, nullable=False, index=True, server_default=text("'0'")
    )
    log_ip = Column(String(40, "utf8_bin"), nullable=False, server_default=text("''"))
...
t_phpbb_login_attempts = Table(
    ...
    metadata,
    Column(
        "attempt_ip", String(40, "utf8_bin"), nullable=False, server_default=text("''")
    ),
    Column(
        "attempt_browser",
        String(150, "utf8_bin"),
    ...
    Column("user_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    Column(
        "username", String(255, "utf8_bin"), nullable=False, server_default=text("'0'")
    ),
    Column(
        "username_clean",
        String(255, "utf8_bin"),
...
class PhpbbMigration(Base):
    ...
    migration_schema_done = Column(Integer, nullable=False, server_default=text("'0'"))
    migration_data_done = Column(Integer, nullable=False, server_default=text("'0'"))
...
t_phpbb_moderator_cache = Table(
    ...
    Column(
        "username", String(255, "utf8_bin"), nullable=False, server_default=text("''")
    ),
    Column("group_id", Integer, nullable=False, server_default=text("'0'")),
    Column(
        "group_name", String(255, "utf8_bin"), nullable=False, server_default=text("''")
    ),
    Column(
        "display_on_index",
        Integer,
...
class PhpbbModule(Base):
    ...
    module_display = Column(Integer, nullable=False, server_default=text("'1'"))
    module_basename = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    module_class = Column(
        String(10, "utf8_bin"), nullable=False, server_default=text("''")
    )
    parent_id = Column(Integer, nullable=False, server_default=text("'0'"))
    left_id = Column(Integer, nullable=False, server_default=text("'0'"))
    right_id = Column(Integer, nullable=False, server_default=text("'0'"))
    module_langname = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    module_mode = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
...
class PhpbbNotificationType(Base):
    ...
    notification_type_name = Column(
        String(255, "utf8_bin"), nullable=False, unique=True, server_default=text("''")
    )
...
class PhpbbNotification(Base):
    ...
    item_parent_id = Column(Integer, nullable=False, server_default=text("'0'"))
    user_id = Column(Integer, nullable=False, server_default=text("'0'"))
    notification_read = Column(Integer, nullable=False, server_default=text("'0'"))
...
t_phpbb_oauth_tokens = Table(
    ...
    Column("user_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    Column(
        "session_id", String(32, "utf8_bin"), nullable=False, server_default=text("''")
    ),
    Column(
        "provider",
        String(255, "utf8_bin"),
...
t_phpbb_poll_options = Table(
    ...
    Column("poll_option_total", Integer, nullable=False, server_default=text("'0'")),
)
...
t_phpbb_poll_votes = Table(
    ...
    metadata,
    Column("topic_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    Column("poll_option_id", Integer, nullable=False, server_default=text("'0'")),
    Column(
...
class PhpbbPost(Base):
    ...
    poster_ip = Column(
        String(40, "utf8_bin"), nullable=False, index=True, server_default=text("''")
    )
    ...
    enable_smilies = Column(Integer, nullable=False, server_default=text("'1'"))
    enable_magic_url = Column(Integer, nullable=False, server_default=text("'1'"))
    enable_sig = Column(Integer, nullable=False, server_default=text("'1'"))
    post_username = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    post_subject = Column(
    ...
    post_checksum = Column(
        String(32, "utf8_bin"), nullable=False, server_default=text("''")
    )
    post_attachment = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    post_postcount = Column(Integer, nullable=False, server_default=text("'1'"))
    post_edit_time = Column(Integer, nullable=False, server_default=text("'0'"))
    post_edit_reason = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    post_edit_user = Column(Integer, nullable=False, server_default=text("'0'"))
    post_edit_count = Column(SmallInteger, nullable=False, server_default=text("'0'"))
    post_edit_locked = Column(Integer, nullable=False, server_default=text("'0'"))
...
class PhpbbPrivmsg(Base):
    ...
    root_level = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    ...
    message_attachment = Column(Integer, nullable=False, server_default=text("'0'"))
    bbcode_bitfield = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    bbcode_uid = Column(
    ...
    message_edit_count = Column(
        SmallInteger, nullable=False, server_default=text("'0'")
    )
    to_address = Column(Text, nullable=False)
    bcc_address = Column(Text, nullable=False)
    message_reported = Column(Integer, nullable=False, server_default=text("'0'"))
...
class PhpbbPrivmsgsRule(Base):
    ...
    rule_connection = Column(Integer, nullable=False, server_default=text("'0'"))
    rule_string = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
t_phpbb_privmsgs_to = Table(
    ...
    Column("pm_forwarded", Integer, nullable=False, server_default=text("'0'")),
...
class PhpbbProfileField(Base):
    ...
    field_type = Column(
        String(100, "utf8_bin"), nullable=False, index=True, server_default=text("''")
    )
    field_ident = Column(
        String(20, "utf8_bin"), nullable=False, server_default=text("''")
    )
    field_length = Column(
        String(20, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    field_novalue = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    field_default_value = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    field_validation = Column(
        String(64, "utf8_bin"), nullable=False, server_default=text("''")
    )
    field_required = Column(Integer, nullable=False, server_default=text("'0'"))
    field_show_on_reg = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    field_show_profile = Column(Integer, nullable=False, server_default=text("'0'"))
    field_show_on_vt = Column(Integer, nullable=False, server_default=text("'0'"))
    field_show_novalue = Column(Integer, nullable=False, server_default=text("'0'"))
    field_show_on_pm = Column(Integer, nullable=False, server_default=text("'0'"))
    field_show_on_ml = Column(Integer, nullable=False, server_default=text("'0'"))
    field_is_contact = Column(Integer, nullable=False, server_default=text("'0'"))
    field_contact_desc = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    field_contact_url = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbProfileFieldsDatum(Base):
    ...
    pf_phpbb_website = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_wlm = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_yahoo = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_aol = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_location = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_facebook = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_googleplus = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_skype = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_twitter = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    pf_phpbb_youtube = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbQaConfirm(Base):
    ...
    session_id = Column(
        String(32, "utf8_bin"), nullable=False, index=True, server_default=text("''")
    )
    confirm_id = Column(
        String(32, "utf8_bin"), primary_key=True, server_default=text("''")
    )
    lang_iso = Column(String(30, "utf8_bin"), nullable=False, server_default=text("''"))
    question_id = Column(Integer, nullable=False, server_default=text("'0'"))
    attempts = Column(Integer, nullable=False, server_default=text("'0'"))
    confirm_type = Column(SmallInteger, nullable=False, server_default=text("'0'"))
...
class PhpbbReport(Base):
    ...
    reason_id = Column(SmallInteger, nullable=False, server_default=text("'0'"))
...
class PhpbbReportsReason(Base):
    ...
    reason_order = Column(SmallInteger, nullable=False, server_default=text("'0'"))
...
class PhpbbSearchWordlist(Base):
    ...
    word_count = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
...
class PhpbbSession(Base):
    ...
    session_ip = Column(
        String(40, "utf8_bin"), nullable=False, server_default=text("''")
    )
    session_browser = Column(
        String(150, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    session_viewonline = Column(Integer, nullable=False, server_default=text("'1'"))
    session_autologin = Column(Integer, nullable=False, server_default=text("'0'"))
...
class PhpbbSessionsKey(Base):
    ...
    last_ip = Column(String(40, "utf8_bin"), nullable=False, server_default=text("''"))
...
class PhpbbSitelist(Base):
    ...
    site_ip = Column(String(40, "utf8_bin"), nullable=False, server_default=text("''"))
    site_hostname = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
...
class PhpbbSmily(Base):
    ...
    code = Column(String(50, "utf8_bin"), nullable=False, server_default=text("''"))
    emotion = Column(String(50, "utf8_bin"), nullable=False, server_default=text("''"))
    smiley_url = Column(
        String(50, "utf8_bin"), nullable=False, server_default=text("''")
    )
    smiley_width = Column(SmallInteger, nullable=False, server_default=text("'0'"))
    smiley_height = Column(SmallInteger, nullable=False, server_default=text("'0'"))
...
class PhpbbStyle(Base):
    ...
    bbcode_bitfield = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("'kNg='")
    )
    style_parent_id = Column(Integer, nullable=False, server_default=text("'0'"))
    style_parent_tree = Column(Text, nullable=False)
    topic_preview_theme = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("'light'")
    )
...
class PhpbbTeampage(Base):
    ...
    group_id = Column(Integer, nullable=False, server_default=text("'0'"))
    teampage_name = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    teampage_position = Column(Integer, nullable=False, server_default=text("'0'"))
    teampage_parent = Column(Integer, nullable=False, server_default=text("'0'"))
...
class PhpbbTopic(Base):
    ...
    forum_id = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    icon_id = Column(Integer, nullable=False, server_default=text("'0'"))
    topic_attachment = Column(Integer, nullable=False, server_default=text("'0'"))
    topic_reported = Column(Integer, nullable=False, server_default=text("'0'"))
    topic_title = Column(
    ...
    poll_max_options = Column(Integer, nullable=False, server_default=text("'1'"))
    poll_last_vote = Column(Integer, nullable=False, server_default=text("'0'"))
    poll_vote_change = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    topic_posts_approved = Column(Integer, nullable=False, server_default=text("'0'"))
    topic_posts_unapproved = Column(Integer, nullable=False, server_default=text("'0'"))
...
t_phpbb_user_group = Table(
    ...
    Column("user_id", Integer, nullable=False, index=True, server_default=text("'0'")),
    Column(
        "group_leader", Integer, nullable=False, index=True, server_default=text("'0'")
    ),
...
t_phpbb_user_notifications = Table(
    ...
    metadata,
    Column(
        "item_type", String(255, "utf8_bin"), nullable=False, server_default=text("''")
    ),
    Column("item_id", Integer, nullable=False, server_default=text("'0'")),
    Column("user_id", Integer, nullable=False, server_default=text("'0'")),
    Column(
        "method", String(255, "utf8_bin"), nullable=False, server_default=text("''")
    ),
...
class PhpbbUser(Base):
    ...
    user_type = Column(Integer, nullable=False, index=True, server_default=text("'0'"))
    group_id = Column(Integer, nullable=False, server_default=text("'3'"))
    user_permissions = Column(String, nullable=False)
    user_perm_from = Column(Integer, nullable=False, server_default=text("'0'"))
    user_ip = Column(String(40, "utf8_bin"), nullable=False, server_default=text("''"))
    ...
    user_email_hash = Column(
        BigInteger, nullable=False, index=True, server_default=text("'0'")
    )
    ...
    user_login_attempts = Column(Integer, nullable=False, server_default=text("'0'"))
    user_inactive_reason = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    user_lang = Column(
        String(30, "utf8_bin"), nullable=False, server_default=text("''")
    )
    user_timezone = Column(
        String(100, "utf8_bin"), nullable=False, server_default=text("''")
    )
    user_dateformat = Column(
        String(30, "utf8_bin"), nullable=False, server_default=text("'d M Y H:i'")
    )
    ...
    user_message_rules = Column(Integer, nullable=False, server_default=text("'0'"))
    ...
    user_topic_show_days = Column(
        SmallInteger, nullable=False, server_default=text("'0'")
    )
    user_topic_sortby_type = Column(
        String(1, "utf8_bin"), nullable=False, server_default=text("'t'")
    )
    user_topic_sortby_dir = Column(
        String(1, "utf8_bin"), nullable=False, server_default=text("'d'")
    )
    user_post_show_days = Column(
        SmallInteger, nullable=False, server_default=text("'0'")
    )
    ...
    user_post_sortby_dir = Column(
        String(1, "utf8_bin"), nullable=False, server_default=text("'a'")
    )
    user_notify = Column(Integer, nullable=False, server_default=text("'0'"))
    user_notify_pm = Column(Integer, nullable=False, server_default=text("'1'"))
    user_notify_type = Column(Integer, nullable=False, server_default=text("'0'"))
    user_allow_pm = Column(Integer, nullable=False, server_default=text("'1'"))
    user_allow_viewonline = Column(Integer, nullable=False, server_default=text("'1'"))
    user_allow_viewemail = Column(Integer, nullable=False, server_default=text("'1'"))
    user_allow_massemail = Column(Integer, nullable=False, server_default=text("'1'"))
    user_options = Column(Integer, nullable=False, server_default=text("'230271'"))
    user_avatar = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    user_avatar_type = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    user_avatar_width = Column(SmallInteger, nullable=False, server_default=text("'0'"))
    user_avatar_height = Column(
        SmallInteger, nullable=False, server_default=text("'0'")
    )
    user_sig = Column(String, nullable=False)
    user_sig_bbcode_uid = Column(
        String(8, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    user_newpasswd = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
    user_form_salt = Column(
        String(32, "utf8_bin"), nullable=False, server_default=text("''")
    )
    ...
    user_rs_notification = Column(Integer, nullable=False, server_default=text("'1'"))
    ...
    user_topic_preview = Column(Integer, nullable=False, server_default=text("'1'"))
...
class PhpbbWord(Base):
    ...
    word_id = Column(Integer, primary_key=True)
    word = Column(String(255, "utf8_bin"), nullable=False, server_default=text("''"))
    replacement = Column(
        String(255, "utf8_bin"), nullable=False, server_default=text("''")
    )
